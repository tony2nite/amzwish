...
== Running from IRB
  ...
  wishlists = Amzwish::Wishlist.find('YOUR@EMAIL.COM')	# loads N wishlists
  books = wishlists[0].books # lists all books for the first wishlist
  books.each {|b| puts b.sync } # sync prices not found on summary page
  books.sort! { |a,b| a.price <=> b.price }
  books.each {|b| puts b.to_s } # iterate through books
